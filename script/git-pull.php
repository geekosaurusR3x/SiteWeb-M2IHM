...
list($return_code, $stdout, $stderr) = pipe_exec('cd ' . $repo . '; git clean -d -f -f; git reset --hard HEAD; git pull; git submodule update --init --recursive; git submodule foreach --recursive "git checkout master; git pull";');
